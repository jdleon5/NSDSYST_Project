...
channel.queue_declare(queue='pmonitor') 
...
msg_dict={'AppID':1, 'name':'Johnny', 'heart rate':heartRate, 'temperature':temperature}
print (msg_dict)
msg_json=json.dumps(msg_dict) 
channel.basic_publish(exchange='', routing_key='pmonitor', body=msg_json) 
